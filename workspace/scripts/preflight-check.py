...
# Use default secure context to prevent MITM (replaces insecure ssl.CERT_NONE)
...
def check_url(url, timeout=10):
    ...
    # SSRF Protection: strictly enforce http/https protocols
    if not re.match(r'^https?://', url, re.I):
        return "DEAD", "Invalid protocol (only http/https allowed)"
